...
const RetExpresTransferModal = ({
  ...
  useEffect(() => {
    ...
    if (amount !== "" && (amt < 2 || amt > 50000)) {
      setErr({ message: "Amount must be between 2 to 50000" });
    } else {
...
<Tooltip title={type === "NEFT" ? "NEFT" : "IMPS"}>
  ...
  {type === "NEFT" ? (
    <img src={neft_l}  onClick={handleOpen}alt="NEFT" style={{ width: '50px', height: '20px' }} />
  ) : (
    <img src={imps_l} onClick={handleOpen} alt="IMPS" style={{ width: '50px', height: '20px' }} />
  )}
        ...
        <Box sx={style} className="sm_modal">
          ...
          >
            ...
            <Grid container sx={{ pt: 1 }}>
              ...
              {amount !== "" && (parseInt(amount) >= 2 && parseInt(amount) <= 50000) && (
                <>
                  <Grid
                    item
                    md={12}
          ...
          {(arrAmtRes && arrAmtRes.length > 0) || onComplete ? (
            ...
            <ModalFooter
              ...
              disable={amount === "" || parseInt(amount) < 2 || parseInt(amount) > 50000}
            />
          )}
        </Box>
      </Modal>
