      ...
      <Grid container sx={{ display: "flex", justifyContent: "start" }}>
        ...
        >
          ...
          <Grid
            ...
            className={`only-cursor myprofile-hover ${
              selectedType === "TOKENDATA" ? "myprofile-active" : ""
            }`}
            onClick={() => {
              setSelectedType("TOKENDATA");
              handleClickScroll();
            }}
          >
            <div style={{ fontWeight: "600", fontSize: "1.1rem" }}>
            ...
            <div style={{ fontSize: "12px" }}>
            Enable the option to reset and obtain the API Token and API Key
            </div>
          </Grid>
)}
  ...
  >
    ...
    >
      ...
      <Grid container sx={{ pt: 1 }}>
        <Grid item md={12} xs={12} sx={{ mx: 2 }}>
          <Typography textAlign="justify">
          API Token and API Key are used to authenticate and authorize requests to a service. These credentials help in managing and controlling access to the service. Ensure that your API Token and API Key are kept secure and not exposed publicly.  </Typography>
        </Grid>
