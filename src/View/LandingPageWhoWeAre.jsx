    ...
    <div className="who-we-are">
      ...
      <section className="introduction">
        <div className="intro-text">
          <p>
            We are a leading fintech company revolutionizing the financial industry through innovative technology and customer-centric services. Our mission is to empower people with better financial tools that enhance transparency, security, and accessibility for all.
          </p>
        </div>
      ...
      <section className="core-values">
        <div className={`value ${scrollY > 200 ? 'fade-in' : ''}`}>
          <h3>Innovation</h3>
          <p>Driving forward with cutting-edge financial solutions that reshape how businesses and individuals manage their finances.</p>
        </div>
        <div className={`value ${scrollY > 400 ? 'fade-in' : ''}`}>
          <h3>Trust</h3>
          <p>Believing in transparency and reliability, ensuring our customers have full control over their financial data.</p>
        </div>
        <div className={`value ${scrollY > 600 ? 'fade-in' : ''}`}>
          <h3>Customer Focus</h3>
          <p>Clients are at the heart of everything we do. We continuously innovate to improve user experience and satisfaction.</p>
        </div>
      </section>
